...
void move(char plate[N][N],int nbj, int pionuti[3],int pionpres1[3], int pionpres2[3], int pionpres3[3]);//fonction qui affiche les actions du pion, contient lenb de joueurs et leur positions à tous
